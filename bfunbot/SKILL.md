...
```json
{
  "models": {
    ...
    "providers": {
      "bfunbot": {
        ...
        "models": [
          { "id": "bfunbot-opus-4-8",              "name": "Claude Opus 4.8",          "api": "anthropic-messages", "contextWindow": 1000000,  "maxTokens": 65536  },
  ...
  "agents": {
    "defaults": {
      "models": {
        "bfunbot/bfunbot-opus-4-8":              { "alias": "bfunbot-opus-4-8" },
